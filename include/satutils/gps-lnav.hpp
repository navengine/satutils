...
// clang-format off
inline constexpr uint8_t GPS_D25[14] = {2,3,4,6,7,11,12,13,14,15,18,19,21,24};   // [1,2,3,5,6,10,11,12,13,14,17,18,20,23]
inline constexpr uint8_t GPS_D26[14] = {3,4,5,7,8,12,13,14,15,16,19,20,22,25};   // [2,3,4,6,7,11,12,13,14,15,18,19,21,24]
inline constexpr uint8_t GPS_D27[14] = {2,4,5,6,8,9,13,14,15,16,17,20,21,23};    // [1,3,4,5,7,8,12,13,14,15,16,19,20,22]
inline constexpr uint8_t GPS_D28[14] = {3,5,6,7,9,10,14,15,16,17,18,21,22,24};   // [2,4,5,6,8,9,13,14,15,16,17,20,21,23]
inline constexpr uint8_t GPS_D29[15] = {2,4,6,7,8,10,11,15,16,17,18,19,22,23,25};// [1,3,5,6,7,9,10,14,15,16,17,18,21,22,24]
inline constexpr uint8_t GPS_D30[13] = {4,6,7,9,10,11,12,14,16,20,23,24,25};     // [3,5,6,8,9,10,11,13,15,19,22,23,24]
// clang-format on
