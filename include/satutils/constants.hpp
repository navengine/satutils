...
using navtools::TwoPi;
using navtools::ComplexI;
using navtools::LIGHT_SPEED;

// These are the exact precision as specified in the IS-GPS-200 documentation
NAV_DEFINE_FP_CONSTANT(GPS_PI, 3.1415926535898);
NAV_DEFINE_FP_CONSTANT(GPS_2PI, 2.0 * GPS_PI<Scalar>);

NAV_DEFINE_FP_CONSTANT(GPS_L1_FREQUENCY, 1.57542e9);
NAV_DEFINE_FP_CONSTANT(GPS_L2_FREQUENCY, 1.22760e9);
NAV_DEFINE_FP_CONSTANT(GPS_L5_FREQUENCY, 1.17645e9);
NAV_DEFINE_FP_CONSTANT(GPS_CA_CODE_RATE, 1.023e6);
NAV_DEFINE_FP_CONSTANT(GPS_L2_CODE_RATE, 511.5e3);
NAV_DEFINE_FP_CONSTANT(GPS_L5_CODE_RATE, 10.23e6);
NAV_DEFINE_FP_CONSTANT(GPS_DATA_BIT_RATE, 50.0);
...
NAV_DEFINE_FP_CONSTANT(GALILEO_E5_FREQUENCY, 1191.795e6);
NAV_DEFINE_FP_CONSTANT(GALILEO_E5A_FREQUENCY, 1176.45e6);
NAV_DEFINE_FP_CONSTANT(GALILEO_E5B_FREQUENCY, 1207.14e6);
NAV_DEFINE_FP_CONSTANT(GALILEO_E6_FREQUENCY, 1278.75e6);
NAV_DEFINE_FP_CONSTANT(GALILEO_E6_CODE_RATE, 5.115e6);
NAV_DEFINE_FP_CONSTANT(GALILEO_E1_DATA_RATE, 250);
NAV_DEFINE_FP_CONSTANT(GALILEO_E5A_DATA_RATE, 50);
NAV_DEFINE_FP_CONSTANT(GALILEO_E5B_DATA_RATE, 250);
NAV_DEFINE_FP_CONSTANT(GALILEO_E6_DATA_RATE, 1000);
